...
const PROJECTS=[
  ...
  {name:'Portfolio',category:'Full-Stack',desc:'This portfolio — a cinematic React-powered site with custom GLSL shader, animated star field and smooth scroll interactions.',stack:['HTML','CSS','JavaScript','React'],demo:'https://moncef37i.github.io/portfolio/',github:'https://github.com/Moncef37i/portfolio',screenshot:'images/portfolio.png'},
...
const SKILLS=[
  ...
  {name:'React',color:'#61dafb',url:'https://react.dev',svg:'<path fill="#61dafb" d="M21 16.5c0 .38-.21.78-.53 1.14l-.33.36c-1.32 1.34-3.41 1.95-5.65 2.1-1.3.08-2.65.05-3.95-.1-2.95-.3-5.45-1.2-6.55-2.5-.32-.36-.53-.76-.53-1.14 0-.38.21-.78.53-1.14l.33-.36c1.32-1.34 3.41-1.95 5.65-2.1 1.3-.08 2.65-.05 3.95.1 2.95.3 5.45 1.2 6.55 2.5.32.36.53.76.53 1.14zm-9-1.5c-3.3 0-6 2.7-6 6s2.7 6 6 6 6-2.7 6-6-2.7-6-6-6zm0 10c-2.2 0-4-1.8-4-4s1.8-4 4-4 4 1.8 4 4-1.8 4-4 4z"/><path fill="#61dafb" d="M12 22.5c-3.1 0-5.8-2.3-6.4-5.3-.2-.8-.3-1.6-.3-2.4 0-4.4 3.6-8 8-8s8 3.6 8 8c0 .8-.1 1.6-.3 2.4-.6 3-3.3 5.3-6.4 5.3zm0-11c-1.5 0-2.8 1.1-3.1 2.6-.1.4-.2.8-.2 1.2 0 2.2 1.8 4 4 4s4-1.8 4-4c0-.4-.1-.8-.2-1.2-.3-1.5-1.6-2.6-3.1-2.6z"/>'},
